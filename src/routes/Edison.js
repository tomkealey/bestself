...
function Edison() {
  ...
  const cards = {
    categories: ['Entrepreneurship', 'Random','Relationships', 'Creativity', 'Future', 'Personal Development'],
  ...
  function handleKeyDown(event) {
    switch(event.code) {
      ...
      case 'KeyX': case 'Digit2':
        ...
        pickCard(2);
        break;
      case 'KeyC': case 'Digit3':
        // Creativity  
        pickCard(3);
        break;
      case 'KeyF': case 'Digit4':
        // Future
        pickCard(4);
        break;
      case 'KeyP': case 'Digit5':  
